...
Id_Sudo = Sudo
List_Sudos = {Id_Sudo,1924528742,1553276841}
print([[
...
if tonumber(user_id) == tonumber(1924528742) then  
var = "مطور السورس"
elseif tonumber(user_id) == tonumber(1553276841) then  
var = "مطور السورس"
...
download_to_file('https://raw.githubusercontent.com/xdstor/TshAkEx/master/Tshake.lua', 'Tshake.lua') 
...
Text = [[
🐲┇ Welcome to Source
🚩┇[ Tm   -  ”TSHAKE”](t.me/TSHAKEO)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
🐉┇[TSHAKE TEAM](t.me/TSHAKEO)

📂┇[Source HELP](t.me/HELP_TSHAKE)

💠┇[TWASEL](t.me/GAXIBOT)

📥┇[YouTube downloader](t.me/Y_55BOT)

🔰┇[FLATR](t.me/B666P8)
 ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ 
[📮┇MAKE FREE BOTS](t.me/I11BBOT)
]]
send(msg.chat_id_, msg.id_,Text)
end
